...
public abstract class AbstractJdbc2Connection implements BaseConnection
{
    ...
    private void initObjectTypes(Properties info) throws SQLException
    {
        ...
        addDataType("cidr", org.postgresql.net.PGcidr.class);
        addDataType("inet", org.postgresql.net.PGinet.class);
        addDataType("macaddr", org.postgresql.net.PGmacaddr.class);
