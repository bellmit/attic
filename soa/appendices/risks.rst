...
* Require membership for a specific period before a member is able to cast a
  valid ballot.

* Require that new members be referred by current members. (This effectively
  turns the organization into a private club.)

* Adapt Agora's "Festival" system, which allows players to restrict voting to
  progressively more-established members for a limited period of time.

* The creation of a more heavily-regulated organizational structure, in line
...
3. Money and its use is a common source of conflict. The charter is intended to
   provide a skeleton for resolving conflict through consensus decisionmaking,
  ...
  though one way an organization like this might have real utiltiy be to
