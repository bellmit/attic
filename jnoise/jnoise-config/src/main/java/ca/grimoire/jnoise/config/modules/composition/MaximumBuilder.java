...
/**
 * A builder capable of creating Maximum noise modules. Maximum noise modules
 * operate on a collection of sources, whose builders should be passed to
 * <code>addChild</code>.
 * 
 * @see jnoise.modules.composition.Maximum
 */
public final class MaximumBuilder extends ModuleElement implements
    ModuleBuilder {

  /**
   * Generates an Maximum noise module using the child elements' modules as
   * sources.
   * 
   * @return an Maximum noise module.
   * @throws BuilderException
   *           if any of the source modules throws an exception.
   * @see ModuleBuilder#createModule()
   */
  public Maximum createModule () throws BuilderException {
    return new Maximum (createSources ());
  }
