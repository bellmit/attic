...
/**
 * Tests that EnumTypeStrategy can convert strings to enumerations.
 */
public final class EnumTypeStrategyTest extends TestCase {
   ...
   * known enumeration.
   */
  public void testDoesntConvertInvalid () {
    try {
  ...
  /**
   * Initializes the test case with an EnumTypeStrategy.
   * 
   * @throws Exception
  ...
  protected void setUp () throws Exception {
    ...
    testStrategy = new EnumTypeStrategy ();
  }

  private EnumTypeStrategy testStrategy;
}
