 ...
 */
public class RidgedMultifractalFrequencyTest extends ModuleFixture {
   ...
   */
  public RidgedMultifractalFrequencyTest () {
    super (new RidgedMultifractal (SEED, OCTAVES, LACUNARITY, WEIGHT,
        FREQUENCY, Gradient.Quality.HIGH));
  }
  ...
  public void testAccessors () {
    assertEquals (SEED, new RidgedMultifractal (SEED, OCTAVES, LACUNARITY,
        WEIGHT, FREQUENCY, Gradient.Quality.HIGH).getSeed ());
    assertEquals (OCTAVES, new RidgedMultifractal (SEED, OCTAVES, LACUNARITY,
        WEIGHT, FREQUENCY, Gradient.Quality.HIGH).getOctaves ());
    assertEquals (LACUNARITY, new RidgedMultifractal (SEED, OCTAVES,
        LACUNARITY, WEIGHT, FREQUENCY, Gradient.Quality.HIGH).getLacunarity ());
    assertEquals (WEIGHT, new RidgedMultifractal (SEED, OCTAVES, LACUNARITY,
        WEIGHT, FREQUENCY, Gradient.Quality.HIGH).getWeight ());
    assertEquals (FREQUENCY, new RidgedMultifractal (SEED, OCTAVES, LACUNARITY,
        WEIGHT, FREQUENCY, Gradient.Quality.HIGH).getFrequency ());
    assertEquals (Gradient.Quality.HIGH, new RidgedMultifractal (SEED, OCTAVES,
        LACUNARITY, WEIGHT, FREQUENCY, Gradient.Quality.HIGH).getQuality ());
  ...
  public void testEquals () {
    assertEquals (module, new RidgedMultifractal (SEED, OCTAVES, LACUNARITY,
        WEIGHT, FREQUENCY, Gradient.Quality.HIGH));
  }
  ...
  public void testHashCode () {
    assertEquals (module.hashCode (), new RidgedMultifractal (SEED, OCTAVES,
        LACUNARITY, WEIGHT, FREQUENCY, Gradient.Quality.HIGH).hashCode ());
  }
}
