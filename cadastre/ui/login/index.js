...
export default class Login extends React.Component {
    ...
    render() {
        ...
        return <Modal
            style={{
                // The docs for react-modal claim that props are merged with the
                // default. Testing determined that that was untrue (though it
                // may be intended), so this instead suppresses the default
                // styling.
                content: {},
            }}
            className={{
                base: 'col-md-4 col-md-offset-4 login-modal-content',
                afterOpen: '',
                beforeClose: '',
            }}
            overlayClassName={{
                base: 'login-modal-overlay',
                afterOpen: '',
                beforeClose: '',
            }}
