...
/**
 * Tests the constructor-driven type conversion strategy.
 */
public final class ConstructorTypeStrategyTest extends TestCase {
   ...
   */
  public void testUnconstructible () {
    try {
  ...
  /**
   * Initializes the test case with a ConstructorTypeStrategy.
   * 
   * @throws Exception
  ...
  protected void setUp () throws Exception {
    ...
    testStrategy = new ConstructorTypeStrategy ();
  }

  private ConstructorTypeStrategy testStrategy;
}
