...
/**
 * Tests the primitive type conversion strategy.
 */
public final class PrimitiveTypeStrategyTest extends TestCase {
  ...
  /**
   * Creates a PrimitiveTypeStrategy for the test.
   * 
   * @throws Exception
  ...
  protected void setUp () throws Exception {
    ...
    testStrategy = new PrimitiveTypeStrategy ();
  }

  private PrimitiveTypeStrategy testStrategy;
}
