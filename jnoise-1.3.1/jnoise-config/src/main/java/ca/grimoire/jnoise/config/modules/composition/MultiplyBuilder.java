...
/**
 * A builder capable of creating Multiply noise modules. Multiply noise modules
 * operate on a collection of sources, whose builders should be passed to
 * <code>addChild</code>.
 * 
 * @see Multiply
 */
public final class MultiplyBuilder extends ModuleElement implements
    ModuleBuilder {

  /**
   * Generates an Multiply noise module using the child elements' modules as
   * sources.
   * 
   * @return an Multiply noise module.
