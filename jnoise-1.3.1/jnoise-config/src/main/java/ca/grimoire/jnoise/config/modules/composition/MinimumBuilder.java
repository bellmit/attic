...
/**
 * A builder capable of creating Minimum noise modules. Minimum noise modules
 * operate on a collection of sources, whose builders should be passed to
 * <code>addChild</code>.
 * 
 * @see jnoise.modules.composition.Minimum
 */
public final class MinimumBuilder extends ModuleElement implements
    ModuleBuilder {

  /**
   * Generates an Minimum noise module using the child elements' modules as
   * sources.
   * 
   * @return an Minimum noise module.
   * @throws BuilderException
   *           if any of the source modules throws an exception.
   * @see ModuleBuilder#createModule()
   */
  public Minimum createModule () throws BuilderException {
    return new Minimum (createSources ());
  }
