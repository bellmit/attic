...
/**
 * Test cases to verify the properties of the Monochrome color palette.
 * 
 * @deprecated The class under test has been deprecated. See {@link Monochrome}
 *             for details.
 */
@Deprecated
public final class MonochromeTest extends PaletteFixture {
  private static final float  HALFTONE    = (float) 0.5;
  private static final double BLACK_VALUE = -2;
  private static final double WHITE_VALUE = 1.0001;
   ...
   * palette.
   */
  public MonochromeTest () {
    super (Monochrome.PALETTE);
  }
