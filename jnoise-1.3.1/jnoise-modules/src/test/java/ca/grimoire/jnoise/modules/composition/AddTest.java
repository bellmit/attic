...
/**
 * Test cases for the Add composition module.
 */
public final class AddTest extends MultiSourceModuleFixture {
  private static final int SEED_1 = 142448;
  private static final int SEED_2 = -68163;

  /**
   * Create a new Add module test, populating the fixture with a known module.
   */
  public AddTest () {
    super (new Add (new Gradient (SEED_1, Gradient.Quality.HIGH), new Gradient (
        SEED_2, Gradient.Quality.HIGH)), new Gradient (SEED_1,
        Gradient.Quality.HIGH), new Gradient (SEED_2, Gradient.Quality.HIGH));
  }

  /**
   * Test that the result of adding the outputs of all source modules is
  ...
  /**
   * Test that the accessors for the Add module return useful information.
   */
  public void testAccessors () {
    for (Module source : new Add (new Gradient (SEED_1, Gradient.Quality.HIGH),
        new Gradient (SEED_2, Gradient.Quality.HIGH)).getSources ()) {
  ...
  public void testEquals () {
    assertEquals (module, new Add (
        new Gradient (SEED_1, Gradient.Quality.HIGH), new Gradient (SEED_2,
  ...
  public void testHashCode () {
    assertEquals (module.hashCode (), new Add (new Gradient (SEED_1,
        Gradient.Quality.HIGH), new Gradient (SEED_2, Gradient.Quality.HIGH))
        .hashCode ());
  }
}
