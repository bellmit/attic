...
public final class Sphere implements CompositeModule {
  ...
  private static Sawtooth composeSphere (double frequency, double amplitude) {
  ...
  public Sphere (double frequency, double amplitude) {
    this.base = composeSphere (frequency, amplitude);
  }
  ...
  /**
   * Returns the frequency of the Sphere function.
   * 
   * @return the Sphere frequency.
   */
  ...
  /**
   * Returns the Sphere value at a given location.
   * 
   * @param x
   ...
   * @return the Sphere value at the location.
  ...
  /**
   * Compares this Sphere module for equality with another object. Sphere
   * modules are equal to other Sphere modules with the same frequency and
   * amplitude.
   * 
   * @param object
