 ...
 * register a {@link SqlSessionFactoryHealthCheck health check} for your database pool, which you can monitor via the
 * health checks admin endpoint.
 * <p>
 ...
 * </pre>
 * <p>
 * There are three ways to configure MyBatis, depending on your needs: <ul> <li>The {@link #AbstractMybatisBundle(Class,
 ...
 * com/example/mappers/Users.xml}.</li> <li>The {@link #AbstractMybatisBundle(String, String...)} constructor accepts a
 * list of packages to scan. Any mapper interfaces defined in these packages <em>or subpackages of these packages</em>
 * will be detected and configured. As with the explicit case, SQL for mappers can be stored in the mapper interface
 * itself, or in XML files.</li> <li>In either of the above cases, or using the {@link #AbstractMybatisBundle()}
 * constructor, you can optionally override the {@link #configureMybatis(Configuration)} method to customize the Mybatis
 * configuration yourself.</li> </ul>
 */
