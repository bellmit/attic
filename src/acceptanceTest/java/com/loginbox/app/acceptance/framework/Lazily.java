...
public class Lazily {
     ...
     * java.util.function.Supplier#get()} method and returns the result otherwise. <p> Intended usage pattern: </p>
     * <pre>
     *     public Config config() {
     *         return this.config = Lazily.create(this.config, this::loadConfigFromFile);
     *     }
     * </pre>
     * <p> You can also pass a lambda or a pre-existing {@link java.util.function.Supplier} instead of a method handle.
     * </p>
     *
     * @param value
